      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="relative z-10 w-full text-left">
            <h1 className="text-2xl md:text-3xl font-extrabold tracking-tight text-white">
              Intel<sup className="text-lg font-light ml-0.5 select-none">®</sup> 교육 과정
            </h1>
        ...
        {loading ? (
          ...
          <div className="bg-white border border-slate-200 p-8 text-center shadow-sm max-w-md mx-auto animate-fade-in">
            ...
            <button
              onClick={handleClearFilters}
              className="bg-brand-primary text-white font-bold text-sm px-5 py-2.5 hover:bg-brand-secondary transition-colors shadow-md active:scale-95 duration-200"
            >
              필터 초기화
            </button>
          </div>
